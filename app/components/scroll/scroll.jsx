...
class Scroll extends React.Component{
    ...
    constructor(props){
        ...
        this.complete    = props.complete || function(){};
    ...
    dealwith(result){
        if(this.totalCount == 0){
            ...
            this.createNodes(result);
        }
    }

    createNodes(result){
        result.datas && result.datas.forEach(function(data,index){
            this.container.appendChild(this.createNode(data,result));
        }.bind(this));
